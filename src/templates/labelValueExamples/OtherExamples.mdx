...
<div className="playground-section">
        ...
        <p className='pt-3'><span>Enter a number value to be retrieved by the LabelValues below</span> </p>
        ...
        <h2>
            LabelValue with no label
        </h2>
        <code>
            `<LabelValue path="label-value-other-number-input"/>`
        </code>
        <div className="label-value-container">
            <LabelValue path="label-value-other-number-input"/>
        </div>
