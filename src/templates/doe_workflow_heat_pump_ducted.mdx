...
<Tabs>
    <Tab eventKey="assessment" title="Assessment">
        ...
        <ShowOrHide visible={!props.data?.no_cooling_appliance?.includes('No cooling appliance')}>
            ...
            <PhotoInput id="existing_cooling_appliance_name_plate_photo" label="Existing Cooling Appliance(s) Name Plate – Photo">
                Take a photo of the existing cooling appliance’s nameplate. If the cooling appliance is a split system include both the indoor and outdoor nameplate.
            </PhotoInput>
        </ShowOrHide>
        ...
        <ShowOrHide visible={props.data?.duct_leakage_test_method === 'Duct leakage tester'}>
            ...
            | <NumberInput label={<>Conditioned Floor Area (ft<sup>2</sup>)</>} min={0} path="cfm25_calculator.conditioned_floor_area"  />
     ...
     <Tab eventKey="planning" title="Planning">
       ## Planned Install Location
        ...
        You are encouraged to use the <a href="https://basc.pnnl.gov/cchp_decision_tool" target="_blank" rel="noopener noreferrer">Cold Climate Heat Pump Decision Tool</a> which
        ...
        <NumberInput label={<>Auxiliary Heat Lockout Above This Temperature (&deg;F)</>} min={0} path="aux_heat_lockout_temperature" />
        <NumberInput label={<>Compressor Lockout Below This Temperature (&deg;F)</>} min={0} path="compresser_lockout_temperature" />
    ...
    <Tab eventKey="installation" title="Installation">
        ...
        <PhotoInput id="furnace_nameplate_photo" label="Furnace nameplate (if dual fuel) – Photo">
            Take a photo of the furnace nameplate (must be legible) if this is a dual fuel setup.
        </PhotoInput>
        ## Electrical
        ...
        <PhotoInput id="vacuum_decay_test_setup_photo" label="Vacuum Decay Test Setup – Photo">
            Take a photo of the vacuum/evacuation setup. Use a core removal tool and minimize number of fittings.
    ...
    <Tab eventKey="post_install" title="Post-Installation">
        ...
        <PhotoInput id="thermostat_setting_photo" label="Thermostat Setting – Photo">
            Take a photo of the thermostat showing the temperature value set for the auxiliary heat lockout, compressor lockout temperature, and dual fuel switch over temperature as applicable.
        </PhotoInput>
    ...
    <Tab eventKey="report" title="Report">
        <PrintSection label="Print Report">
            ...
            commissioning are paramount to ensuring maximum equipment efficiency and a long trouble-free equipment life.
            ...
            ## Quarterly
            ### Air Filter
            Check the air filter quarterly and replace as needed. If your system was designed to take a 1&rdquo; thick
            pleated filter, they will get dirty and need to be replaced sooner than if the system was designed to
            take a 4&rdquo; filter. Ask your HVAC installer what filter MERV (minimum efficiency reporting value) rating
            ...
            ## Pre-Upgrade Tests
            <LabelValue label="This heat pump will" value={props.data?.heat_pump_purpose}/>
            ...
            <LabelValue label="Cooling appliance exists" value={props.data?.no_cooling_appliance?.includes('No cooling appliance') ? "No" : "Yes"}/>
            <ShowOrHide visible={!props.data?.no_cooling_appliance?.includes('No cooling appliance')}>
                <Photo
                ...
                <Photo id="existing_cooling_appliance_name_plate_photo"
                    label="Existing Cooling Appliance(s) Name Plate – Photo"
                    required>
                    Photo of the existing cooling appliance’s nameplate. If the cooling appliance is a split system this includes both the indoor and outdoor nameplate.
                </Photo>
            ...
            <LabelValue label="Ductwork Comments" value={props.data?.comment_ductwork}/>
            ...
            <LabelValue label="Pre-Upgrade Static Pressure Test Notes" value={props.data.comment_pre_upgrade_static_pressure_test}/>
            ...
            <LabelValue label="Pre-Upgrade Airflow Test Notes" value={props.data.comment_pre_upgrade_air_flow_test}/>
            ...
            <LabelValue label="Test method used" value={props.data?.duct_leakage_test_method}/>
            <ShowOrHide visible={props.data?.duct_leakage_test_method === 'Duct leakage tester'}>
                ...
                <LabelValue label="Type Of Duct Leakage Test Performed" value={props.data.type_of_duct_leakage_radio}/>

                <LabelValue label="CFM25" value={props.data.cfm25_calculator?.cfm25 ? props.data.cfm25_calculator.cfm25 : null}/>
                <LabelValue label={<span>Conditioned Floor Area (ft<sup>2</sup>)</span>}
                    value={props.data.cfm25_calculator?.conditioned_floor_area ? props.data.cfm25_calculator.conditioned_floor_area : null}/>
                <LabelValue label={<span>Duct CFM25 per 100 ft<sup>2</sup></span>}
                    type={props.data.cfm25_calculator?.cfm25 && props.data.cfm25_calculator?.conditioned_floor_area ? "number" : "string"}
                    decimalPlaces={2}
                    value={ props.data.cfm25_calculator?.cfm25 && props.data.cfm25_calculator?.conditioned_floor_area ? ((props.data.cfm25_calculator.cfm25 / props.data.cfm25_calculator.conditioned_floor_area) * 100) : null }/>
            </ShowOrHide>
            ...
            <LabelValue label="ODU Mounting Style" value={props.data.outdoor_unit?.odu_mounting_style}/>

            <LabelValue label="ODU Inches Above The Ground (elevated above the snow)" value={props.data.outdoor_unit?.odu_inches_above_ground}/>

            <LabelValue label="Overhead Snow & Ice Protection" value={props.data.outdoor_unit?.snow_ice_protection}/>
            ...
            <LabelValue label="Manual J Notes or Comments" value={props.data.comment_manual_j}/>
            ## Equipment Selection
            ...
            <LabelValue label={<span>Auxiliary Heat Lockout Above This Temperature (&deg;F)</span>} value={props.data.aux_heat_lockout_temperature}/>

            <LabelValue label={<span>Compresser Lockout Below This Temperature (&deg;F)</span>} value={props.data.compresser_lockout_temperature}/>

            <LabelValue label={<span>Dual Fuel Switch Over Temperature (&deg;F)</span>} value={props.data.dual_fuel_switch_over_temperature}/>
            ...
            <LabelValue label="Pre-Installation Comments" value={props.data.comment_ductwork_concluding_summary}/>
            ...
            <Photo id="furnace_nameplate_photo" label="Furnace nameplate (if dual fuel) – Photo">
                Photo of the furnace nameplate (if this is a dual fuel setup)
            </Photo>
            ...
            <LabelValue label="Circuit Breaker Notes" value={props.data.comment_circuit_breaker_notes}/>
            ...
            | Ounces of additional refrigerant = {(props.data?.refrigerant_calculator?.ft_line_set_beyond_factory_charge && props.data?.refrigerant_calculator?.oz_per_ft_refrigerant) ? props.data.refrigerant_calculator.ft_line_set_beyond_factory_charge  * props.data.refrigerant_calculator.oz_per_ft_refrigerant : null}
            <LabelValue label="Notes About Refrigerant Quantity Adjustments Or Weigh In"
                        value={props.data.comment_refrigerant_quantity_adjustments_or_weigh_in}/>
            ...
            <LabelValue label="Post-Installation Notes About Thermostat Settings"
                        value={props.data.comment_about_thermostat_settings}/>
