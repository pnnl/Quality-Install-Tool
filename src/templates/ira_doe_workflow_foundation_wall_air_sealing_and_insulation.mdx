...
<Tabs>
  <Tab eventKey="pre-installation" title="Pre-Installation">
    ...
    *	The ASHRAE 62.2 standard does not require the installation of a system smaller than 15 CFM (7 L/s)
    ...
    Use this section to document the existing condition of the conditioned crawlspace or conditioned basement that needs additional insulation and air sealing along the exterior walls, or unconditioned crawlspace to be encapsulated.

    <PhotoInput id="repair_needed_photo" label="Areas that need repair/correction/improvements before insulation and air sealing – Photos">
  ...
  <Tab eventKey="installation" title="Installation">
    ...
    * If the material’s moisture content is above 18% efforts should be made to dry the material and prevent it from getting wet in the future prior to applying air sealing and insulation products.
    ...
    <PhotoInput id="rim_joist_air_sealed_photo" label="Rim Joist Air Sealed (if applicable) – Photos" >
      Photo showing spray foam or caulking applied to rim joist for air sealing
    </PhotoInput>

    <PhotoInput id="crawlspace_vents_photo" label="Crawlspace Vents Sealed (if applicable) – Photos" >
      Crawlspace vents blocked and sealed with spray foam
    </PhotoInput>

    <PhotoInput id="foundataion_wall_sealed_photo" label="Foundation Wall Air Sealed (if applicable) – Photos" >
...
## Ventilation
 ...
 <Tab eventKey="report"  title="Report">
    ...
    ## Proposed Scope of Retrofit Work
    <Photo id="repair_needed_photo" label="Areas that need repair/correction/improvements before insulation and air sealing – Photos" required>
    ...
    <Photo id="rim_joist_air_sealed_photo" label="Rim Joist Air Sealed (if applicable) – Photos">
      Photo showing spray foam or caulking applied to rim joist for air sealing
    </Photo>

    <Photo id="crawlspace_vents_photo" label="Crawlspace Vents Sealed (if applicable) – Photos">
      Photo of Crawlspace vents blocked and sealed with spray foam
    </Photo>

    <Photo id="foundataion_wall_sealed_photo" label="Foundation Wall Air Sealed (if applicable) – Photos">
