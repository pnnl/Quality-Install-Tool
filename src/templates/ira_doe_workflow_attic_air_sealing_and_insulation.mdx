<Tabs>
  ...
  <Tab eventKey="pre-installation" title="Pre-Installation">
    ...
    <Radio label="What is the starting air leakage rate for the home before modification?" options={['Don\'t know','CFM at 50Pa']} path="air_leakage_rate_radio" />
    ...
    * Pest entry can rapidly damage air sealing and insulation materials thus it is important to check and remediate prior to work. 
    ...
    <Radio label="What is the roof condition?" options={['Good','Potential Issue']} path="insulation_roof_condition" />
    ...
    <Radio label="What is the drainage system condition?" options={['Good','Potential Issue']} path="insulation_drainage_condition" />
    ...
    *	The ASHRAE 62.2 standard does not require the installation of a system smaller than 15 CFM (7 L/s)
    ...
    <Radio label="Has an ASHRAE 62.2 calculation been performed pre-retrofit?" options={['Yes','No']} path="ashrae_62_2_calculation" />
  ...
  ## Final Conditions
  <Radio label="What is the air sealing level you have achieved?" options={['Don\'t know','CFM at 50Pa']} path="postinstall_air_leakage_rate_radio" />  
  <ShowOrHide visible={props.data?.postinstall_air_leakage_rate_radio === 'CFM at 50Pa'}> 
