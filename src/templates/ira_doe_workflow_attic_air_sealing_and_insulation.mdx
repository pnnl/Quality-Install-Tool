<Tabs>
  ...
  <ShowOrHide visible={props.data?.postinstall_attic_air_leakage_rate === 'CFM at 50Pa'}>
    ...
    | <p><strong>ACH50: </strong>{!isNaN(props?.data?.postinstall_air_leakage_cfm50) && !isNaN(props?.data?.conditioned_volume_ft3) ? (props?.data?.postinstall_air_leakage_cfm50 * 60) / props?.data?.conditioned_volume_ft3: 'N/A'}</p>
...
<ShowOrHide visible={props.data?.attic_air_leakage_rate == 'CFM at 50Pa'} >
    ...
    <ShowOrHide visible={props.data?.attic_air_leakage_rate == 'CFM at 50Pa'} >
      ...
      <p>Conditioned Volume (ft3): <strong>{props.data?.conditioned_volume_ft3}</strong> </p>
      <p> ACH50 : <strong> {!isNaN(props?.data?.postinstall_air_leakage_cfm50) && !isNaN(props?.data?.conditioned_volume_ft3) ? (props?.data?.postinstall_air_leakage_cfm50 * 60) / props?.data?.conditioned_volume_ft3: 'N/A'}</strong></p>
