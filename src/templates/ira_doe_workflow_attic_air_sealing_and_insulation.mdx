...
<>
    <table>
        <tbody>
            <tr>
                <td>Conditioned Volume (ft3)</td>
                <td>{props.data?.conditioned_volume_ft3}</td>
            </tr>
            <tr>
                <td>ACH50</td>
                <td>{(props?.data?.air_leakage_cfm50 * 60)/props?.data?.conditioned_volume_ft3 }</td>
            </tr>
        </tbody>
    </table>
    <Photo
        ...
        required
    >
        Photo of the manometer showing CFM50 of air leakage before air sealing
