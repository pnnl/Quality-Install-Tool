...
<Tabs>
  <Tab eventKey="pre-installation" title="Pre-Installation">
    ...
    *	The ASHRAE 62.2 standard does not require the installation of a system smaller than 15 CFM (7 L/s)
    ...
    Use this section to document the existing condition and proposed areas where air sealing and insulation will be added to the slab perimeter.
  ...
  <Tab eventKey="installation" title="Installation">
    ...
    <PhotoInput id="insulation_product_photo" label="Insulation product installed – Photo" >
      Take a photo of the insulation product installed showing its R-value.
    </PhotoInput>
...
<Select
    ...
    options={['R-5', 'R-10', 'R-15', 'Other']}
    path="postinstall_foundation_r_value"
/>
<ShowOrHide visible={props.data?.postinstall_foundation_r_value === 'Other'}>
    <StringInput
        label="Notes (Other R-Value)"
        path="postinstall_foundation_r_value_other"
    />
</ShowOrHide>
...
## Ventilation
 ...
 <Tab eventKey="report"  title="Report">
    ...
    <Photo id="insulation_product_photo" label="Insulation product installed – Photo" required>
       Photo of the insulation product installed showing its R-value
    </Photo>
    ...
    <p> What R-value was added to the foundation perimeter? <strong>{props.data?.postinstall_foundation_r_value === 'Other' ? props.data?.postinstall_foundation_r_value_other : props.data?.postinstall_foundation_r_value}</strong> </p>
