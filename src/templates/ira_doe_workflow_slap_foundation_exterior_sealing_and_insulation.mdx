<Tabs>
 ...
 <Tab eventKey="report"  title="Report">
    ...
    props.data?.postinstall_foundation_air_leakage_cfm50 === 'CFM at 50Pa' ? props.data?.postinstall_foundation_air_leakage_cfm50 + " " : null} {props.data?.postinstall_foundation_air_leakage_level}</strong> </p>
