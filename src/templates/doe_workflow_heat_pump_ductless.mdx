...
<Tabs>
    ...
    <Tab eventKey="planning" title="Planning">
        ...
        This ductless heat pump will...

        <Select label="Heating" options={[
        ...
        <Select label="Cooling" options={[
            "Add cooling to an area that previously didn't have cooling",
            "Replace existing cooling equipment",
            "Reduce the cooling load of other cooling system(s) in the home"
            ]} path="heat_pump_cooling_purpose" />
        ...
        <PhotoInput id="existing_cooling_appliance_photo" label="Existing cooling appliance – Photo">
            Take a picture of the existing cooling appliance. If the existing appliance is a split system take a picture of both the indoor unit and the outdoor unit.
        </PhotoInput>
        <PhotoInput id="existing_cooling_appliance_name_plate_photo" label="Existing cooling appliance nameplate – Photo">
            Take a picture of the existing cooling appliance’s nameplate (please make sure it is legible). If the equipment doesn’t have a nameplate write “no nameplate” in the Notes. If the existing appliance is a split system take a picture of both the indoor unit and the outdoor unit nameplates.
        </PhotoInput>
        ...
        heat pump for this home. The <a href="https://basc.pnnl.gov/cchp_decision_tool" target="_blank" rel="noopener noreferrer">Cold Climate Heat Pump Decision Tool</a> will make use of the Manual J load values and
    ...
    <Tab eventKey="installation" title="Installation">
        ...
        <PhotoInput id="flare_tested_in_a_flare_guage_photo" label="Flare Tested In A Flare Gauge – Photo">
            ...
            Don&apos;t be surprised if you need to remake a flare more than once. It isn&apos;t always user error, variations in line set
            copper quality contributes to the probability imperfect flares. Consider using a cylinder-style reaming and deburring
            tool instead of a pen-style especially for small diameter lines. &frac14;&quot; flares can be the most difficult to make that fits perfectly in a
            flare gauge because of the difficulty of reaming and deburring the pipe just the right amount.
        </PhotoInput>
        ...
        <StringInput  label="Notes About Refrigerant Adjustment" path="comment_refridgerant_adjustment" />
    ...
    <Tab eventKey="report" title="Report">
       ...
       <PrintSection label="Print Report">
           ...
           <ProjectInfoReport {...props} />
            ...
            when changing from heating to cooling or vice versa. The same applies to multi-split heat pumps
            ...
            ## Pre-Installation
            <LabelValue label="This ductless heat pump will (Heating)" value={props.data?.heat_pump_purpose}/>
            <LabelValue label="This ductless heat pump will (Cooling)" value={props.data?.heat_pump_cooling_purpose}/>
            ...
            <Photo id="existing_cooling_appliance_photo" label="Existing cooling appliance – Photo" required>
                Photo of the existing cooling appliance
            </Photo>
            <Photo id="existing_cooling_appliance_name_plate_photo" label="Existing cooling appliance nameplate – Photo" required>
            ...
            <LabelValue label="Notes" value={props.data.comment_odu_install_location}/>
            ...
            <LabelValue label="Notes" value={props.data.comment_idu_install_location}/>
            ...
            <Photo id="idu_name_plate_photo" label="Indoor Unit Nameplate – Photo" required>
            ...
            <LabelValue label="Notes About Refrigerant Adjustment" value={props.data.comment_refridgerant_adjustment}/>
