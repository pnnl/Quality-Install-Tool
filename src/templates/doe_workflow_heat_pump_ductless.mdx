<Tabs>
    ...
    <Tab eventKey="planning" title="Planning">
        ...
        <StringInput  label="Comment" path="comment_euipment_selection" hint="Comment if there will be backup or auxiliary heat sources, e.g. electric resistance baseboard heaters will be left in place as a backup or auxiliary heat source." />
    ...
    <Tab eventKey="report" title="Report">
        ...
        <PrintSection label="Print Report">
           ...
           <ProjectInfoReport {...props} />
            ...
            {props.data?.project_invoice_photo && (
            <>## Project Invoice
