<Tabs>
  <Tab eventKey="assessment" title="Installation">
    ...
    <PhotoInput id="manometer_external_static_pressure_photo" label="Monometer Showing External Static Pressure – Photo">
    ...
    <PhotoInput id="air_flow_measurement_photo" label="Airflow Measurement – Photo">
      Take a photo of the airflow measurement. Measurements obtained by a TrueFlow grid, air flow capture hood, or balometer are valid. Make adjustments to the fan setting as needed to achieve target airflow. 
    </PhotoInput>

    <PhotoInput id="air_filter_photo" label="Air Filter – Photo">
      Take a photo of the air filter. If the system has an air filter slot, to show that the front has a gasketed door, if the system has an air filter grille, to show that the perimeter is sealed to minimize air bypassing the filter.
    </PhotoInput>
  ...
  <Tab eventKey="report" title="Report">
    ...
    <Photo id="manometer_external_static_pressure_photo" label="Monometer Showing External Static Pressure – Photo" required>
