...
<Tab eventKey="report" title="Report">
  ...
  **Assessment For:** {props.data.assessment_for}
  ...
  <p>
  {props.data.assessment_for === 'Whole multifamily building' 
    ? <LabelValue label={<span>Multifamily Building Conditioned Area (ft<sup>2</sup>)</span>} value={props.data.mf_conditioned_floor_area_sq_ft}/>
    : <LabelValue label={<span>Single-family/unit Conditioned Area  (ft<sup>2</sup>)</span>} value={props.data.sf_conditioned_floor_area_sq_ft}/>
  }
  </p>
  ...
  **Whole-Dwelling Ventilation Rate (CFM):** {props.data.is_whole_home_ventilation_system_rated_flow_cfm_known === "YES"
  ...
  {props.data.heating_systems &&
    ...
    {Number(props.data.num_heating_systems) > 0 && props.data.heating_systems[0] &&
      <>
        ...
        <LabelValue label="Fuel and System Type" value={props.data.heating_systems[0].fuel_and_system_type}/>


        {props.data.heating_systems[0].fuel_and_system_type === 'ELECTRIC_HEAT_PUMP' 
          ?  <LabelValue label="Heating Efficiency (HSPF)" value={props.data.heating_systems[0].is_efficiency_known === 'YES' ? props.data.heating_systems[0].efficiency_hspf : "NOT_KNOWN"}/>
          :  <LabelValue label="Heating Efficiency (AFUE)" value={props.data.heating_systems[0].is_efficiency_known === 'YES' ? props.data.heating_systems[0].efficiency_afue : "NOT_KNOWN"}/>
        }
       <LabelValue label="Percent Conditioned Area Served" value={props.data.heating_systems[0].is_percent_conditioned_floor_area_served_known === 'YES' ? props.data.heating_systems[0].percent_conditioned_floor_area_served : "NOT_KNOWN"}/>
      </>
    }
    {Number(props.data.num_heating_systems) > 1 && props.data.heating_systems[1] &&
      <>
        <h3>Heating System 2</h3>
        <LabelValue label="Fuel and System Type" value={props.data.heating_systems[1].fuel_and_system_type}/>

        {props.data.heating_systems[1].fuel_and_system_type === 'ELECTRIC_HEAT_PUMP' 
          ?  <LabelValue label="Heating Efficiency (HSPF)" value={props.data.heating_systems[1].is_efficiency_known === 'YES' ? props.data.heating_systems[1].efficiency_hspf : "NOT_KNOWN"}/>
          :  <LabelValue label="Heating Efficiency (AFUE)" value={props.data.heating_systems[1].is_efficiency_known === 'YES' ? props.data.heating_systems[1].efficiency_afue : "NOT_KNOWN"}/>
        }

      <LabelValue label="Percent Conditioned Area Served" value={props.data.heating_systems[1].is_percent_conditioned_floor_area_served_known === 'YES' ? props.data.heating_systems[1].percent_conditioned_floor_area_served : "NOT_KNOWN"}/>      
      </>
    }
    {Number(props.data.num_heating_systems) > 2 && props.data.heating_systems[2] &&
      <>
        ...
        <LabelValue label="Fuel and System Type" value={props.data.heating_systems[2].fuel_and_system_type}/>

        {props.data.heating_systems[2].fuel_and_system_type === 'ELECTRIC_HEAT_PUMP' 
          ?  <LabelValue label="Heating Efficiency (HSPF)" value={props.data.heating_systems[2].is_efficiency_known === 'YES' ? props.data.heating_systems[2].efficiency_hspf : "NOT_KNOWN"}/>
          :  <LabelValue label="Heating Efficiency (AFUE)" value={props.data.heating_systems[2].is_efficiency_known === 'YES' ? props.data.heating_systems[2].efficiency_afue : "NOT_KNOWN"}/>
        }

      <LabelValue label="Percent Conditioned Area Served" value={props.data.heating_systems[2].is_percent_conditioned_floor_area_served_known === 'YES' ? props.data.heating_systems[2].percent_conditioned_floor_area_served : "NOT_KNOWN"}/>
      </>
    }
    </>
  }
  ...
  {props.data.cooling_systems &&
    ...
    {Number(props.data.num_cooling_systems) > 0 && props.data.cooling_systems[0] &&
      <>
        <h3>Cooling System 1</h3>
        <LabelValue label="Cooling Efficiency (SEER)" value={props.data.cooling_systems[0].is_efficiency_known === 'YES' ? props.data.cooling_systems[0].efficiency_seer : "NOT_KNOWN"}/>
        <LabelValue label="Percent Conditioned Area Served" value={props.data.cooling_systems[0].is_percent_conditioned_floor_area_served_known === 'YES'  ? props.data.cooling_systems[0].percent_conditioned_floor_area_served : "NOT_KNOWN"}/>
      </>
    }
    {Number(props.data.num_cooling_systems) > 1 && props.data.cooling_systems[1] &&
      <>
        <h3>Cooling System 2</h3>
        <LabelValue label="Cooling Efficiency (SEER)" value={props.data.cooling_systems[1].is_efficiency_known === 'YES' ? props.data.cooling_systems[1].efficiency_seer : "NOT_KNOWN"}/>
        <LabelValue label="Percent Conditioned Area Served" value={props.data.cooling_systems[1].is_percent_conditioned_floor_area_served_known === 'YES'  ? props.data.cooling_systems[1].percent_conditioned_floor_area_served : "NOT_KNOWN"}/>
      </>
    }
    {Number(props.data.num_cooling_systems) > 2 && props.data.cooling_systems[2] &&
      <>
        <h3>Cooling System 3</h3>
        <LabelValue label="Cooling Efficiency (SEER)" value={props.data.cooling_systems[2].is_efficiency_known === 'YES' ? props.data.cooling_systems[2].efficiency_seer : "NOT_KNOWN"}/>
        <LabelValue label="Percent Conditioned Area Served" value={props.data.cooling_systems[2].is_percent_conditioned_floor_area_served_known === 'YES'  ? props.data.cooling_systems[2].percent_conditioned_floor_area_served : "NOT_KNOWN"}/>
      </>
    }
    </>
  }
