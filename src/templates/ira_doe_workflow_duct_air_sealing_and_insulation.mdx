...
<Tabs>
  <Tab eventKey="pre-installation" title="Pre-Installation">
    ...
    <PhotoInput id="existing_static_pressure_test_setup_photo" label="Existing condition total static pressure test setup – Photo">
       Photo showing the total static pressure test setup
    </PhotoInput>
    ...
    *	The purpose of looking and evaluating is to reduce the incidents of air sealing and insulating ducts or return(s) that will need to be taken apart and upgraded. It is better to include in the scope of work the duct upgrades and air seal and insulate the new duct work.
    ...
    <PhotoInput id="existing_duct_insulation_vapor_barrier_needed_photo" label="Areas where duct insulation/vapor barrier can be added – Photo">
    Take photos of areas where insulation can be added to the ducts. Also take photos of areas were vapor barrier needs to be added to the the existing ducts. Bare/unfaced fiberglass insulation on ducts that will get cold air (AC) in unconditioned spaces like attics, basements, or crawl spaces can result in condensation. Some homes may have ducts insulated with bare/unfaced fiberglass insulation, that is fine if the ducts will only carry heated air, but if AC has been or will be added, condensation risk must be evaluated.
    </PhotoInput>
 ...
 <Tab eventKey="report"  title="Report">
    ...
    <Photo id="existing_duct_insulation_vapor_barrier_needed_photo" label="Areas where duct insulation/vapor barrier can be added – Photo" required>
        Photos of areas where duct insulation/vapor barrier can be added
    </Photo>
