<Tabs>
 ...
 <Tab eventKey="report"  title="Report">
    ...
    <p> Total duct leakage before air sealing:  <strong> { props.data?.existing_duct_leakage_rate_radio} { props.data?.existing_duct_leakage_rate_radio == 'CFM at 50Pa' ? ": " + props.data?.duct_leakage_cfm50  : null } </strong></p>
   ...
   <Photo id="secure_and_seal_duct_photo" label="Secure and seal duct boots – Photo" required>
    ...
    <p> Total duct leakage after air sealing:  <strong> { props.data?.postinstall_duct_leakage_rate} </strong> </p>
