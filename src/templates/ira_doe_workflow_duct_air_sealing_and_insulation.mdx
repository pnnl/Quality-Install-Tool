  ...
  <Tab eventKey="pre-installation" title="Pre-Installation">
    ...
    <ShowOrHide visible={props.data?.existing_duct_leakage_rate_radio === 'CFM at 25Pa'}>
      <PhotoInput id="conditioned_floor_area_calculation_photo" label="Conditioned Floor Area Calculation – Photo">
        ...
        | <p><strong>Cubic feet per minute (CFM) per 100 sq. ft. of conditioned floor area when the air handler is present: </strong>{props.data?.duct_leakage_cfm25/props.data?.conditioned_floor_area_ft2*100}</p>
    </ShowOrHide>
 ...
 <Tab eventKey="report"  title="Report">
    ...
    <ShowOrHide visible={props.data?.existing_duct_leakage_rate_radio === 'CFM at 25Pa'}>
      <Photo id="conditioned_floor_area_calculation_photo" label="Conditioned Floor Area Calculation – Photo" required>
        ...
        |Cubic feet per minute (CFM) per 100 sq. ft. of conditioned floor area when the air handler is present |{props.data?.duct_leakage_cfm25/props.data?.conditioned_floor_area_ft2*100}
    </ShowOrHide>
