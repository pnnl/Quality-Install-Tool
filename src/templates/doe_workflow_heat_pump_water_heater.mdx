...
<Tabs>
  <Tab eventKey="pre_installation" title="Pre-Installation">
    ...
    Consider using the <a href="https://basc.pnnl.gov/hpwh_installation_tool" target="_blank" rel="noopener noreferrer">Heat Pump Water Heater Selection Tool</a> to help choose the optimal HPWH for the home.
    <Collapsible header="HPWH Space Evaluation — Instructions">
      ...
      entered in the &ldquo;Space Air Volume&rdquo; input below.
    ...
    <NumberInput label={<>Space Air Volume (ft<sup>2</sup>)</>} min={0} path="space_air_volume" />

    <PhotoInput id="hpwh_location_photo" label="HPWH Location – Wide-Angle Photo">
      Provide a wide-angle photo of the space where the HPWH will be installed to best capture the space requirements
      from the &ldquo;HPWH Space Evaluation - Instructions&rdquo; above.
    </PhotoInput>
    ...
    <Collapsible header="HPWH & Building Science">
      ...
      dew point and condenses to cause water damage or mold problems. Depressurizing a zone
      ...
      the cool air could possibly lower the temperature of the surface to the point of dew point
  ...
  <Tab eventKey="installation" title="Installation">
    ...
    <Collapsible header="HPWH Installation - Instructions">
      ...
      | Capacity (gal)| Filled Weight (lbs) |
      | --- | --- |
      | 50  | 573 |
      | 66  | 796 |
      | 80  | 921 |
  ...
  <Tab eventKey="report" title="Report">
    ...
    *The photos and information in this report use timestamps and geotags to prevent the reuse of photos
    ...
    <Photo id="hpwh_location_photo" label="HPWH Location – Wide-Angle Photo" required>
    ...
    <LabelValue label="Air Volume of the Space" value={<span>{props.data.space_air_volume} ft<sup>3</sup></span>}/>
    ...
    <Photo id="mode_photo" label="HPWH Screen with Mode – Photo" required>
      This close-up photo shows the mode setting of the HPWH.
    </Photo>
    ...
    Most HPWHs have electric resistance elements to provide supplemental heat in certain modes.
    ...
    replenishes the heat in the tank quickly but less efficiently using the electric resistance elements
