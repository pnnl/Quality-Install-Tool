...
<Tabs>
  <Tab eventKey="pre_installation" title="Pre-Installation">
    ...
    ## Existing Conditions
    <Radio label="What is the fuel type of your existing water heater?" options={["Gas", "Electric", "Oil", "None"]} path="existing_water_heater_fuel_type" />
    <Radio label="What is the type of your water heating system before upgrading to a heat pump water heater?" options={["Water heater with storage tank", "Tankless water heater", "Don’t know"]} path="existing_water_heater_type" />
    <Radio label="What is the storage capacity before and after? " options={["Less than 45 gal", "45 gal", "50 gal", "60 gal", "80 gal", "More than 80 gal"]} path="water_heater_storage_capacity" />
...
| Air Volume = {props.data.volume_calculator?.length} x {props.data.volume_calculator?.width} x {props.data.volume_calculator?.height} = {props.data.volume_calculator?.length * props.data.volume_calculator?.width * props.data.volume_calculator?.height} ft<sup>3</sup> |
  ...
  <Tab eventKey="report" title="Report">
    ...
    *The photos and information in this report use timestamps and geotags to prevent the reuse of photos 
    ...
    <p>What is the storage capacity before and after? <strong>{props.data?.water_heater_storage_capacity}</strong> </p>
