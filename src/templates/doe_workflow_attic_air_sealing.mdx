<Tabs>
  ...
  <Tab eventKey="assessment" title="Assessment">
    ...
    E.g. just blowing an attic with loose fill fiberglass, cellulose, or mineral wood without first 
    checking air sealing details have been performed is not an acceptable practice. 
    Instead HEAR (50122) requires air sealing efforts to precede insulation work unless the 
    insulation is spray foam. The air sealing and insulation don’t have to be done by the same 
    contractor. While not required, often to achieve comprehensive high quality air sealing, the attic 
    first needs to be cleaned of dust, debris, and/or degraded insulation. Prior to air sealing inspect 
    the attic for damaged or missing framing members, exhaust fans venting to the attic, unsafe wiring,
     water leaks, mold, poor condition duct work, and old or unsafe HVAC or water heating appliances. 
     Replacing these appliances in the attic afterwards can significantly damage or disturb air 
