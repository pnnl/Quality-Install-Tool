<Tabs>
    ...
    <Tab eventKey="assessment" title="Assessment">
        ...
        <StringInput label="Comments on Pre-Upgrade Air Flow Test" path="comments_pre_upgrade_air_flow_test" hint="Comment on remediation plan if flow is much lower than 400 CFM per ton" />
    ...
    <Tab eventKey="installation" title="Installation">
        ...
        <PhotoInput id="odu_circuit_breaker_photo" label="ODU circuit breaker – Photo">
            Take a photo showing the ampacity of the breaker.
        </PhotoInput>
        ...
        <PhotoInput id="nitrogen_pressure_test_setup_photo" label="Nitrogen Pressure Test Setup – Photo">
            Take a photo of the nitrogen pressure test setup.
        </PhotoInput>
        ...
        <PhotoInput id="vaccum_decay_test_results_photo" label="Vacuum Decay Test Results – Photo">
            Take a photo of the vacuum decay test results. Use a digital micron gauge. System must be isolated from vaccum pump. Vaccum must not rise above 500 microns in 15 minutes.
        </PhotoInput>
        ...
        <PhotoInput id="refrigerant_adjustments_if_applicable_photo" label="Refrigerant Adjustments (if applicable) – Photo">
            Take a photo of scale readout and calculations for refrigerant charge adjustment.
        </PhotoInput>
    ...
    <Tab eventKey="report" title="Report">
         ...
         <PrintSection label="Print Report">
            ...
            <Photo id="pre_upgrade_air_flow_test_results_photo" label="Pre-Upgrade Air Flow Results – Photo" >
            ...
            | CFM25 per 100 ft<sup>2</sup> Calculator
            | ---------------
            | CFM @ 25 Pa = {props.data.cfm25_calculator?.cfm25 ? props.data.cfm25_calculator.cfm25 : null} 
            | Conditioned Floor Area = {props.data.cfm25_calculator?.conditioned_floor_area ? props.data.cfm25_calculator.conditioned_floor_area : null} 
            | CFM25 per 100 per ft<sup>2</sup> = { props.data.cfm25_calculator?.cfm25 && props.data.cfm25_calculator?.conditioned_floor_area ? ((props.data.cfm25_calculator.cfm25 / props.data.cfm25_calculator.conditioned_floor_area) * 100).toFixed(2) : null } 
