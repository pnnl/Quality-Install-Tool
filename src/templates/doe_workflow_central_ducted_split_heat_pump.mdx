<Tabs>
    ...
    <Tab eventKey="assessment" title="Assessment">
        ...
        <StringInput label="Comment on remediation plans" path="comment_pre_upgrade_static_pressure_test" hint="If total external static pressure is above 0.5 i.w.c" />
       ...
       ## Planned Install Location
        ...
        ## Equipment Performance Tables
         <Collapsible header="Equipment Selection Details">
            Select the equipment based on the ASHRAE heating and cooling design conditions, Manual J loads, manufactuer's heating and cooling 
            output capacity at the design conditions (often found by looking up the extended performance tables). 
            Use the NEEP Heat Pump List as an alternative source for equipment output capacity at the design conditions. 
            Factor in auxiliary heat, or dual fuel into the equipment selection as applicable. 
        </Collapsible>
        <PhotoInput id="mfg_extended_heating_performance_table_photo" label="MFG's Heating Performance Table – Photo" uploadable>
        ...
        <PhotoInput id="mfg_extended_cooling_performance_table_photo" label="MFG's cooling performance table – Photo" uploadable>
    ...
    <Tab eventKey="report" title="Report">
         ...
         <PrintSection label="Print Report">
            ...
            
            {
                ...
                <h2> Manual J </h2>
                {
                props.metadata.attachments['manual_j_file'] ? <p>Please see the PDF containing the Manual J report attached.</p> : null
                }
            ...
            and cooling design conditions, and Manual J load calculations to select the best equipment to fit the home's heating and cooling needs.
            ...
            
            {
                ...
                ? <p><strong>Ductwork Concluding Comments: </strong> {props.data.comment_ductwork_concluding_summary}</p> 
                : null
            }
