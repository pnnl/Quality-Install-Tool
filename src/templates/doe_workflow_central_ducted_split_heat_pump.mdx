<Tabs>
    ...
    <Tab eventKey="report" title="Report">
         ...
         <PrintSection label="Print Report">
            ...
            <br/>
            ## Manual J
            Please see the PDF containing the Manual J report attached.
            {
            ...
            ## Refrigerant Adjustments
            <Photo id="refrigerant_adjustments_if_applicable_photo" label="Refrigerant Adjustments (if applicable) – Photo" required >
            ...
            <FileRenderer id="manual_j_file" label="PDF of Manual J - File" />
