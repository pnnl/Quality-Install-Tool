...
<div className="playground-section">
        ...
        <code>
            `<LabelValue path="label-value-other-text-input" type="number" decimalPlaces={2}/>`
        </code>
        <div className="label-value-container">
            <LabelValue
        ...
        <p style={{paddingTop: `10px`}}> Enter a number value to be retrieved by the LabelValues below</p>
        ...
        <code>
            `<LabelValue path="label-value-other-number-input" type="string" decimalPlaces={2}/>`
        </code>
        <div className="label-value-container">
            <LabelValue
