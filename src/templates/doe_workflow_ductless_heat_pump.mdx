<Tabs>
    ...
    <Tab eventKey="pre_installation" title="Pre-Installation">
        ...
        <PhotoInput id="cooling_performance_table_photo" label="Cooling Performance Table – Photo">
    ...
    <Tab eventKey="installation" title="Installation">
        ...
        <PhotoInput id="odu_name_plate_photo" label="ODU Name Plate – Photo" uploadable>
        ...
        | <NumberInput label="Ounce / per ft of additional line set" min={0} path="oz_refrigerant_calculation.oz_refrigerant_to_add_per_ft"  /> 
