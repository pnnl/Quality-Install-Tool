<Tabs>
  ...
  <Tab eventKey="report"  title="Report">
    ...
    {props.data?.whole_house_ventilation && props.data?.whole_house_ventilation === "Yes" && (
    <> 
      <Photo id="existing_mechanical_ventilation_air_flow_measurement_photo" label="Existing Whole-House Mechanical Ventilation Air Flow Measurement – Photo" />
    ...
    <ShowOrHide visible={["Continuous exhaust","Balanced supply and return", "Energy recovery ventilation", "Heat recovery ventilation"].includes(props.data?.ventilation_equipemnt_selection)}>
      <Photo id="air_flow_measurement_exhaust_photo" label="Air Flow Measurement Exhaust – Photo" />
    </ShowOrHide>
    <ShowOrHide visible={["Supply only","Balanced supply and return", "Energy recovery ventilation", "Heat recovery ventilation"].includes(props.data?.ventilation_equipemnt_selection)}>
      <Photo id="air_flow_measurement_supply_photo" label="Air Flow Measurement Supply – Photo" />
    </ShowOrHide>
