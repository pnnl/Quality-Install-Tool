...
<Tabs>
  <Tab eventKey="pre_installation" title="Pre-Installation">
    ...
    * If the ASHRAE 62.2 mechanical ventilation calculator finds that the home should have a whole-house mechanical ventilation system installed, please use this workflow to document.
    ...
    <PhotoInput id="red_calc_ventilation_calculation_photo" label="RED Calc Ventilation Calculation Screenshot (optional)" uploadable>
      Optional: upload a screenshot of the ventilation CFM calculations in RED Calc used to determine the required ventilation.
    </PhotoInput>
    ...
    <PhotoInput id="ventilation_improvements_needed_photo" label="Areas where ventilation improvements are needed - Photo">
      Example: a bathroom that lacks a bath fan, or a kitchen that lacks a range hood.
    </PhotoInput>
    <PhotoInput id="ventilation_equipment_to_be_replaced_photo" label="Ventilation equipment that will be replaced - Photo">
      If there are old/worn out ventilation equipment that will be replaced take a photo of it.
    </PhotoInput>
    <PhotoInput id="ventilation_equipment_to_be_replaced_nameplate_photo" label="Nameplate of ventilation equipment that will be replaced – Photo">
      If there are old/worn out ventilation equipment that will be replaced take a photo of its nameplate. If it contains no nameplate write “no nameplate” in the Notes.
    </PhotoInput>
...
<PhotoInput id="project_invoice_photo" label="Project Invoice – Photo">
  ...
  <Tab eventKey="report"  title="Report">
    ...
    {props.metadata?.attachments?.red_calc_ventilation_calculation_photo && (
      <Photo id="red_calc_ventilation_calculation_photo" label="RED Calc Ventilation Calculation Screenshot (optional)">
        Screenshot of the ventilation CFM calculations in RED Calc used to determine the required ventilation
      </Photo>
    )}
    ...
    <ShowOrHide visible={props.data?.whole_house_ventilation === "Yes"}>
     ...
     <Photo id="ventilation_improvements_needed_photo" label="Areas where ventilation improvements are needed - Photo" required>
      Photo of areas where ventilation improvements are needed
    </Photo>
    <Photo id="ventilation_equipment_to_be_replaced_photo" label="Ventilation equipment that will be replaced - Photo" required>
      Photo of the ventilation equipment that will be replaced
    </Photo>
    <Photo id="ventilation_equipment_to_be_replaced_nameplate_photo" label="Nameplate of ventilation equipment that will be replaced – Photo" required>
      Photo of the nameplate of the ventilation equipment that will be replaced
    </Photo>
