...
<Tabs>
  <Tab eventKey="installation" title="Installation">
    ...
    ## General
    <PhotoInput id="existing_water_heater_photo" label="Existing water heater – Photo">
      Take a picture of the existing water heater.
    </PhotoInput>

    <PhotoInput id="existing_water_heater_name_plate_photo" label="Existing water heater nameplate – Photo">
      Take a picture of the existing water heater’s nameplate (please make sure it is legible). If the equipment doesn’t have a nameplate write “no nameplate” in the Notes.
    </PhotoInput>

    <PhotoInput id="nameplate_photo" label="New Water Heater Nameplate – Photo">
  ...
  <Tab eventKey="report" title="Report">
    ...
    ### General
    <Photo id="existing_water_heater_photo" label="Existing water heater – Photo" required>
      Photo of the existing water heater
    </Photo>

    <Photo id="existing_water_heater_name_plate_photo" label="Existing water heater nameplate – Photo" required>
      Photo of the existing water heater’s nameplate
    </Photo>

    <Photo id="nameplate_photo" label="New Water Heater Nameplate – Photo" required>
