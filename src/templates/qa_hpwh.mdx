...
Volume of space supplying air to the HPWH = {props.doc.volume_calculator?.length * props.doc.volume_calculator?.width * props.doc.volume_calculator?.height} ft<sup>3</sup>
