...
<Tabs>
  <Tab eventKey="qa_form" style={{paddingTop:"1rem"}} title="QA Form">
    ...
    <Collapsible header="HPWH Space Evaluation — Instructions">
      ...
      7. in the 40°–90° F (4.4°–32.2° C) temperature range year-round
...
Install Date: {(new Date(props.doc.install_date)).toLocaleDateString('en-us', {month:"long", day:"numeric", year:"numeric"})}
