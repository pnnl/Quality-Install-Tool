...
<Tabs>
  <Tab title="Tab 2" content="Content 2" print={true} eventKey="tab2" style={{ paddingTop: "1rem" }} />
  <Tab eventKey="qa_form" style={{paddingTop:"1rem"}} title="QA Form" print=true>
...
Install Date: {(new Date(props.doc.install_date)).toLocaleDateString('en-us', {timeZone: 'UTC', month:"long", day:"numeric", year:"numeric"})}
