...
<Tabs>
  <Tab eventKey="customer" style={{paddingTop:"1rem"}} title="Project">
    The inputs on this tab could be filled in prior to the initial site visit.
  ...
  <Tab eventKey="planned" style={{paddingTop:"1rem"}} title="Assessment">
  The inputs on this tab could be filled in during the initial site visit.
  ...
  <Tab eventKey="sizing" style={{paddingTop:"1rem"}} title="Sizing">
  ...
  <Tab eventKey="install" style={{paddingTop:"1rem"}} title="Installation">
