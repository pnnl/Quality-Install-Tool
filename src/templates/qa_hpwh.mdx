...
<Tabs>
  <Tab eventKey="project" style={{paddingTop:"1rem"}} title="Project">
    ...
    *The Installer inputs are all optional*
  ...
  <Tab eventKey="report" style={{paddingTop:"1rem"}} title="Report">
    ...
    *The photos and information in this report use timestamps and geotags to prevent the reuse of photos 
...

    {
      ...
      ? <span><strong>Air Volume of the Space:</strong> {props.data.space_air_volume} ft<sup>3</sup></span> 
      : null
    }

    {/* {
      props.metadata.old_nameplate_photo
