...
| Air Volume = {props.doc.data_?.volume_calculator?.length} x {props.doc.data_?.volume_calculator?.width} x {props.doc.data_?.volume_calculator?.height} = {props.doc.data_?.volume_calculator?.length * props.doc.data_?.volume_calculator?.width * props.doc.data_?.volume_calculator?.height} ft<sup>3</sup>
...
Address: {props.doc.data_?.location?.street_address}, {props.doc.location?.city}, {props.doc.data_?.location?.state} {props.doc.data_?.location?.zip_code}

Installer: {props.doc.data_?.installer}

Install Date: <DateStr date={props.doc.data_?.install_date}/>
...
Volume of space supplying air to the HPWH = {props.doc.data_?.volume_calculator?.length * props.doc.data_?.volume_calculator?.width * props.doc.data_?.volume_calculator?.height} ft<sup>3</sup> (Must be at least 700 ft<sup>3</sup>)
