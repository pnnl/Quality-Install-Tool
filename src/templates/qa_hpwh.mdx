...
<Tabs>
  ...
  The data for this tab should be collected during the initial site visit.
    ...
    <Collapsible header="HPWH Space Evaluation — Instructions">
      ...
      To verify conditions 1-7 have been met, use the "HPWH Location" photo input to
      take a
      wide-angle photo of the space where the HPWH will be installed. If the HPWH is to
      be ducted or using the air volume of an adjacent space via a louvered door,
      supply a photo of the connected space using the "Adjacent Space" photo input.
