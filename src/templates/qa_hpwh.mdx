...
Address: {props.data.location?.street_address}, {props.data.location?.city}, {props.data.location?.state} {props.data.location?.zip_code}

Installer: {props.data.installer}

Install Date: <DateStr date={props.data.install_date}/>
...
Volume of space supplying air to the HPWH = {props.data.volume_calculator?.length * props.data.volume_calculator?.width * props.data.volume_calculator?.height} ft<sup>3</sup> (Must be at least 700 ft<sup>3</sup>)
