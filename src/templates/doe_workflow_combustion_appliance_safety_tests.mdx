...
<Tabs>
    <Tab eventKey="test" title="Appliance Safety Tests" >
        <Collapsible header="Combustion Appliance Safety Testing Details">
            ...
            <a
                href="https://www.bpi.org/__cms/docs/ANSI%20BPI-1200-S-2017%20Standard%20Practice%20for%20Basic%20Analysis%20of%20Buildings.pdf"
        ...
        <RepeatableInput path="combustion_safety_tests" label="Appliance" labelPath="appliance_type" maxValuesCount={5}>
            <Radio
