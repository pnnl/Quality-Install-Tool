...
<p> Enter a value to be retrieved by the LabelValues below</p>

<TextInput path="label-value-test-input" />
...
<code>
    `<LabelValue path="existing_cooking_appliance_type" />`
</code>
...
<code>
    `<LabelValue path="existing_cooking_appliance_type" type="number" />`
</code>
<div className="label-value-container">
    <LabelValue path="label-value-test-input" type="number" />
</div>
