<Tabs>
  ...
  <Tab eventKey="report"  title="Report">
    ...
    <p> What is the fuel type of the new stovetop/oven/range?   <strong> { props.data.postinstall_cooking_appliance_type ? props.data.postinstall_cooking_appliance_type : null } </strong> </p>
