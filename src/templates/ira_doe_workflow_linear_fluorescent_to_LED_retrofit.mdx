...
<LabelValue label="Number of Fixtures Retrofitted" path="num_fixtures_retrofitted" required={true}/>
<LabelValue label="Number of Lamps/Bulbs Retrofitted" path="num_lamps_bulbs_retrofitted" required={true}/>
