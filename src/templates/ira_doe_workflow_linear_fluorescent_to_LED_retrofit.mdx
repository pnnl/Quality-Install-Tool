...
<Photo id="fixture_ballast_photo" label="Fixture Ballast – Photo" required>
    Photo of the fixture’s ballast. If there is more than one fixture being
    retrofitted, take a representative photo. If there are labels or markings
    about the ballast type, date of manufacturing, model number, please
    photograph from close enough to read the information.
</Photo>
...
<Photo
    ...
    required>
      ...
      Photo of the make and model number of the LED lamp.
...
<Photo 
    ...
    Photo of the information about the color temperature, wattage, and lumen.
...
<Photo 
    ...
    required>
      ...
      Photo of the make and model of the dimmer, if used. Test the dimmer to ensure the light dimming works.
...
<Photo id="fixture_rewired_photo_b" label="Fixture Rewired – Photo" required>
    Photo of the rewired fixture. If there are more than one fixture being
    retrofitted, take a representative photo.
</Photo>
...
<Photo
    ...
    Photo of the LED driver. If there is a label or markings detailing the
    date of manufacturing, model number, maximum output current, etc.,
    please photograph from close enough to read the information. This photo
    will be very helpful for maintenance staff in the future for ordering
    compatible replacement lamps.
