...
precacheAndRoute([{'revision':'37afcc792c52a89b684673b9e4a52a5f','url':'/index.html'},{'revision':null,'url':'/static/css/main.e53a2a99.css'},{'revision':null,'url':'/static/js/787.c4a51308.chunk.js'},{'revision':'fb05aa648ce1cbf209410c9220711fac','url':'/third_party_license.json'}]);// Set up App Shell-style routing, so that all navigation requests
