...
precacheAndRoute([{'revision':'c2713dc808a80e2a24d94f39326e4e1c','url':'/Quality-Install-Tool/index.html'},{'revision':null,'url':'/Quality-Install-Tool/static/css/main.fd630494.css'},{'revision':null,'url':'/Quality-Install-Tool/static/js/787.f3f1eca8.chunk.js'},{'revision':null,'url':'/Quality-Install-Tool/static/js/main.4acf2bd5.js'}]);// Set up App Shell-style routing, so that all navigation requests
...
return true;},createHandlerBoundToURL("/Quality-Install-Tool"+'/index.html'));// An example runtime caching route for requests that aren't handled by the
