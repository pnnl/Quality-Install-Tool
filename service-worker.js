...
precacheAndRoute([{'revision':'2c894aa85187df1cf1dadd782eedaff4','url':'/index.html'},{'revision':null,'url':'/static/css/main.110b77e0.css'},{'revision':null,'url':'/static/js/787.c4a51308.chunk.js'},{'revision':null,'url':'/static/js/main.0284c43d.js'},{'revision':null,'url':'/static/media/pdf.worker.min.02d2a460fe525d5cbdf3.js'},{'revision':'e9e2c961117c92f448570a53ec2f4d90','url':'/third_party_license.json'}]);// Set up App Shell-style routing, so that all navigation requests
// are fulfilled with your index.html shell. Learn more at
// https://developers.google.com/web/fundamentals/architecture/app-shell
var fileExtensionRegexp=/\/[^/?]+\.[^/]+$/;registerRoute(// Return false to exempt requests from being fulfilled by index.html.
...
if(url.pathname.match(fileExtensionRegexp)!=null){return false;}// Return true to signal that we want to use the handler.
return true;},createHandlerBoundToURL(""+'/index.html'));// An example runtime caching route for requests that aren't handled by the
